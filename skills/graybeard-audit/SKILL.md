...
description: >
  Whole-repo audit for stack-practice and maintainability risks. Finds
  non-standard framework usage, weak boundaries, missing constraints, risky
  dependencies, weak proof, and overbuilt areas. Report only.
license: MIT
---

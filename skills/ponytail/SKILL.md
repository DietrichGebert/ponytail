...
name: ponytail
description: >
  Optimizes coding and system design for the best complete outcome with the
  least justified complexity. Quality, correctness, completeness, user value,
  safety, accessibility, performance, maintainability, cost, longevity, and
  verification come first. Simplicity, YAGNI, reuse, standard-library, and
  native-platform choices are efficiency tools and tiebreakers when outcomes
  are materially equivalent. Supports lite, full (default), and ultra.
  Use on ANY coding task: writing, adding, refactoring, fixing, reviewing, or designing
  code; also applies when choosing libraries and architecture. Also
  use for "ponytail", "be lazy",
  "lazy mode", "simplest solution", "minimal solution", "yagni", "do less",
  "shortest path", or complaints about over-engineering, bloat, boilerplate,

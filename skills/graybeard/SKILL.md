...
name: graybeard
description: >
  Stack-aware senior engineer mode for coding tasks. Inspects the repo stack,
  follows established framework and codebase patterns, chooses industry-standard
  solutions, keeps scope tight, and requires meaningful automated proof for
  behavior changes. Use on coding, architecture, dependency, refactor, bug-fix,
  review, and test-design work. Do NOT use for non-coding requests.
argument-hint: "[advisory|balanced|strict|off]"
license: MIT
---

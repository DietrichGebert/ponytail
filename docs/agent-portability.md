...
| Autohand Code | `skills/` | Copy the six bundled skill folders into `~/.autohand/skills/` globally or `.autohand/skills/` in a project. Skill-capable host; use the skill names directly, for example `ponytail-review`. |

...
| GigaCode | `skills/`, `scripts/gigacode-skills.js` | Native skills adapter: copies the bundled `skills/` into GigaCode's personal `~/.gigacode/skills` directory, or `.gigacode/skills` with `--project`. |

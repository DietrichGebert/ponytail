...
- `skills/ponytail-plan/SKILL.md`: create or simplify a plan without implementation
- `skills/ponytail-ask/SKILL.md`: clarify consequential requirements without implementation

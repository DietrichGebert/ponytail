...
- `skills/ponytail-diag/SKILL.md`: structured debugging with flow traces, truth tables, hypothesis testing (one-line verdict by default)
- `skills/ponytail-port/SKILL.md`: port feasibility scoring with direct/adapt/rethink mapping (one-line verdict by default)

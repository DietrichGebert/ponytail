...
function getFallbackInstructions(mode) {
  return 'PONYTAIL MODE ACTIVE — level: ' + mode + '\n\n' +
    ...
    'Lazy code without its check is unfinished: ordinary non-trivial logic leaves ONE runnable check behind (assert-based demo/self-check or one small test file; no frameworks). Security-sensitive paths are exempt from that one-check ceiling: run relevant existing tests and add enough focused checks to cover each affected trust boundary and abuse case. Trivial one-liners need no test.\n\n' +
    '## Boundaries\n\n' +

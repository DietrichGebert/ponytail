...
The correctness benchmark spawns Python for email and CSV checks; `python3` is tried before `python`. CSV checks need the benchmark Python dependencies installed locally:

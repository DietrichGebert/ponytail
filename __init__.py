...
def _fallback_instructions(mode: str) -> str:
    return (
        ...
        "A deletion is done when surviving code has no dangling references. "
        "Check callers (including spread/dynamic props), comments, tests, and "
        "`ponytail:` markers; move still-relevant rationale, retarget tests for "
        "behavior that remains, and remove markers only when their ceiling disappears. "
